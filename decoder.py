...
class VAE_Decoder(nn.Sequential):
    def __init__(self):
        super().__init__(
            ...
            # (Batch_Size, 256, Height / 8, Width / 8) -> (Batch_Size, 256, Height / 4, Width / 4)
            ...
            # (Batch_Size, 128, Height, Width) -> (Batch_Size, 64, Height, Width)
            ...
            # (Batch_Size, 64, Height, Width) -> (Batch_Size, 3, Height, Width)
